(function (global, factory) {
	...
	function create_fragment(ctx) {
		...
		internal.handle_promise(promise = Promise.resolve().then(/*wait*/ ctx[6]).then(/*load*/ ctx[4]).then(/*preload*/ ctx[5]), info);
		...
		return {
			...
			p(new_ctx, [dirty]) {
				...
				if (dirty & /*load, preload*/ 48 && promise !== (promise = Promise.resolve().then(/*wait*/ ctx[6]).then(/*load*/ ctx[4]).then(/*preload*/ ctx[5])) && internal.handle_promise(promise, info)) ; else {
